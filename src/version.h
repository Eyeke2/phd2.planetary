...
#define PHD_VER_SOLAR_MAJOR  3
#define PHD_VER_SOLAR_PATCH  0
#define PHD_VER_REVISION     (PHD_VER_SOLAR_MAJOR * 1000 + PHD_VER_SOLAR_PATCH)
...
#ifdef __cplusplus
static_assert(PHD_VER_REVISION == PHD_VER_SOLAR_MAJOR * 1000 + PHD_VER_SOLAR_PATCH,
...
#define PHD_VER_SUBSTRING  "-solar.3"
