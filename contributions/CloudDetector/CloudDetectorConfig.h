...
#define CONFIG_CLOUD_SUSPECT_QUIET_MS 15000
#define CONFIG_CLOUD_RECOVER_HOLD_MS 15000
#define CONFIG_CLOUD_RECOVER_MIN_SAMPLES 3
#define CONFIG_CLOUD_RECOVERY_TREND_MS 60000
#define CONFIG_CLOUD_TREND_SAMPLE_MS 1000
#define CONFIG_CLOUD_TREND_MASS_FRAC 0.01f
#define CONFIG_CLOUD_TREND_SNR_DB 0.15f
#define CONFIG_CLOUD_TREND_NOISE_K 2.0f
#define CONFIG_CLOUD_SAMPLE_GAP_MIN_MS 10000
#define CONFIG_CLOUD_SAMPLE_GAP_EXPOSURES 2
#define CONFIG_CLOUD_GUIDE_WAIT_ALLOWANCE_MS 5000
#define CONFIG_CLOUD_FAULT_RECOVERY_SAMPLES 3
#define CONFIG_CLOUD_FAULT_MAX_AUTO_RETRIES 3

#define CONFIG_CLOUD_OBSCURED_HAZE_PERCENT 90.f
#define CONFIG_CLOUD_MASS_DECLINE_PCT_PER_MINUTE 1.f
#define CONFIG_CLOUD_DECLINE_HEALTHY_RECOVERY_MS 180000
